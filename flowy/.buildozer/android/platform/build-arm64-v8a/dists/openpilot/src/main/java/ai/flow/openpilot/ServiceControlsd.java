...
public class ServiceControlsd extends PythonService {
	...
	_start(ctx,  "", "Openpilot", "Controlsd", pythonServiceArgument);
    }
    ...
    static public Intent getDefaultIntent(Context ctx, String smallIconName,
					  ...
					  String pythonServiceArgument) {
        String appRoot = PythonUtil.getAppRoot(ctx);
        Intent intent = new Intent(ctx, ServiceControlsd.class);
        intent.putExtra("androidPrivate", appRoot);
        intent.putExtra("androidArgument", appRoot);
        intent.putExtra("serviceEntrypoint", "controlsd.py");
        intent.putExtra("serviceTitle", "Controlsd");
        intent.putExtra("pythonName", "Controlsd");
    ...
    protected Intent getThisDefaultIntent(Context ctx, String pythonServiceArgument) {
        return ServiceControlsd.getDefaultIntent(ctx,  "", "", "",
