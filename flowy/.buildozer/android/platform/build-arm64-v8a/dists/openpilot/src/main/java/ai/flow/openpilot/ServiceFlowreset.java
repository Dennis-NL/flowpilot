...
public class ServiceFlowreset extends PythonService {
	...
	_start(ctx,  "", "Openpilot", "Flowreset", pythonServiceArgument);
    }
    ...
    static public Intent getDefaultIntent(Context ctx, String smallIconName,
					  ...
					  String pythonServiceArgument) {
        String appRoot = PythonUtil.getAppRoot(ctx);
        Intent intent = new Intent(ctx, ServiceFlowreset.class);
        intent.putExtra("androidPrivate", appRoot);
        intent.putExtra("androidArgument", appRoot);
        intent.putExtra("serviceEntrypoint", "flowreset.py");
        intent.putExtra("serviceTitle", "Flowreset");
        intent.putExtra("pythonName", "Flowreset");
    ...
    protected Intent getThisDefaultIntent(Context ctx, String pythonServiceArgument) {
        return ServiceFlowreset.getDefaultIntent(ctx,  "", "", "",
