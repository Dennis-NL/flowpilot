...
public class ServiceDebugd extends PythonService {
	...
	_start(ctx,  "", "Openpilot", "Debugd", pythonServiceArgument);
    }
    ...
    static public Intent getDefaultIntent(Context ctx, String smallIconName,
					  ...
					  String pythonServiceArgument) {
        String appRoot = PythonUtil.getAppRoot(ctx);
        Intent intent = new Intent(ctx, ServiceDebugd.class);
        intent.putExtra("androidPrivate", appRoot);
        intent.putExtra("androidArgument", appRoot);
        intent.putExtra("serviceEntrypoint", "debugd.py");
        intent.putExtra("serviceTitle", "Debugd");
        intent.putExtra("pythonName", "Debugd");
    ...
    protected Intent getThisDefaultIntent(Context ctx, String pythonServiceArgument) {
        return ServiceDebugd.getDefaultIntent(ctx,  "", "", "",
