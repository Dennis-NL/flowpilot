...
public class ServiceKeyvald extends PythonService {
	...
	_start(ctx,  "", "Openpilot", "Keyvald", pythonServiceArgument);
    }
    ...
    static public Intent getDefaultIntent(Context ctx, String smallIconName,
					  ...
					  String pythonServiceArgument) {
        String appRoot = PythonUtil.getAppRoot(ctx);
        Intent intent = new Intent(ctx, ServiceKeyvald.class);
        intent.putExtra("androidPrivate", appRoot);
        intent.putExtra("androidArgument", appRoot);
        intent.putExtra("serviceEntrypoint", "keyvald.py");
        intent.putExtra("serviceTitle", "Keyvald");
        intent.putExtra("pythonName", "Keyvald");
    ...
    protected Intent getThisDefaultIntent(Context ctx, String pythonServiceArgument) {
        return ServiceKeyvald.getDefaultIntent(ctx,  "", "", "",
