...
public class ServiceLogmessaged extends PythonService {
	...
	_start(ctx,  "", "Openpilot", "Logmessaged", pythonServiceArgument);
    }
    ...
    static public Intent getDefaultIntent(Context ctx, String smallIconName,
					  ...
					  String pythonServiceArgument) {
        String appRoot = PythonUtil.getAppRoot(ctx);
        Intent intent = new Intent(ctx, ServiceLogmessaged.class);
        intent.putExtra("androidPrivate", appRoot);
        intent.putExtra("androidArgument", appRoot);
        intent.putExtra("serviceEntrypoint", "logmessaged.py");
        intent.putExtra("serviceTitle", "Logmessaged");
        intent.putExtra("pythonName", "Logmessaged");
    ...
    protected Intent getThisDefaultIntent(Context ctx, String pythonServiceArgument) {
        return ServiceLogmessaged.getDefaultIntent(ctx,  "", "", "",
