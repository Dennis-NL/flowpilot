...
public class ServiceCalibrationd extends PythonService {
	...
	_start(ctx,  "", "Openpilot", "Calibrationd", pythonServiceArgument);
    }
    ...
    static public Intent getDefaultIntent(Context ctx, String smallIconName,
					  ...
					  String pythonServiceArgument) {
        String appRoot = PythonUtil.getAppRoot(ctx);
        Intent intent = new Intent(ctx, ServiceCalibrationd.class);
        intent.putExtra("androidPrivate", appRoot);
        intent.putExtra("androidArgument", appRoot);
        intent.putExtra("serviceEntrypoint", "calibrationd.py");
        intent.putExtra("serviceTitle", "Calibrationd");
        intent.putExtra("pythonName", "Calibrationd");
    ...
    protected Intent getThisDefaultIntent(Context ctx, String pythonServiceArgument) {
        return ServiceCalibrationd.getDefaultIntent(ctx,  "", "", "",
