...
public class ServicePlannerd extends PythonService {
	...
	_start(ctx,  "", "Openpilot", "Plannerd", pythonServiceArgument);
    }
    ...
    static public Intent getDefaultIntent(Context ctx, String smallIconName,
					  ...
					  String pythonServiceArgument) {
        String appRoot = PythonUtil.getAppRoot(ctx);
        Intent intent = new Intent(ctx, ServicePlannerd.class);
        intent.putExtra("androidPrivate", appRoot);
        intent.putExtra("androidArgument", appRoot);
        intent.putExtra("serviceEntrypoint", "plannerd.py");
        intent.putExtra("serviceTitle", "Plannerd");
        intent.putExtra("pythonName", "Plannerd");
    ...
    protected Intent getThisDefaultIntent(Context ctx, String pythonServiceArgument) {
        return ServicePlannerd.getDefaultIntent(ctx,  "", "", "",
